...
% Modification by Oliver Whyte, 2011
...
while beta < beta_max
    ...
    for Inniter = 1:mit_inn
      ...
      Fyout = bsxfun(@rdivide, Nomin1 + gamma*fft2(Wxx), Denom); 
...
% Added by Oliver Whyte
yout = padImage(yout, -pad_replicate);
...
Nomin1 = bsxfun(@times, conj(otfk), fft2(y));
Denom1 = abs(otfk).^2; 
